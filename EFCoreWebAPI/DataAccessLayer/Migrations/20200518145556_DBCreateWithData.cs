...
{
    public partial class DBCreateWithData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondName = table.Column<string>(maxLength: 45, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Adress", "ClientTypeId", "FirstName", "LastName", "PhoneNumber", "SecondName" },
                values: new object[] { 1, null, 1, "Admin", "Admin", null, "Admin" });
